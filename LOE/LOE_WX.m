...
function LOE()
    ...
    excelPath = [outPath '\' excelName]; % excel路径
    ipicPath =  ['G:\Dataset\LL_Set\' llTestset '\'];     % 低照度图像
...
%     epicPath = ['F:\Area 51\9.winter_is_here\storm\compare\真实图\基于深度学习方法\' methon '\' llTestset '\'];
